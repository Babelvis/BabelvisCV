...
\addsocialnetworkdata{\faLinkedin}{www.linkedin.com/in/daan-roeterink/}{LinkedIn}
\addsocialnetworkdata{\faGithub}{https://github.com/daanroeterink}{Github (Privé projecten)}

%                            COMPETENTIES

% add Competenties Usage:
% \addcompetenciesdata{<Text>}
\addcompetenciesdata{Samenwerkingsgericht}
\addcompetenciesdata{Loyaal en betrouwbaar}
\addcompetenciesdata{Leergierig en nieuwsgierig}
\addcompetenciesdata{Oplossingsgericht}
\addcompetenciesdata{Verbindend vermogen}
