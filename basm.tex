...
\sncustomdata{\faLinkedin}{https://www.linkedin.com/in/bas-magre/}{LinkedIn}
\sncustomdata{\faYoutube}{https://www.youtube.com/@justanotherdevopsguy}{Youtube kanaal}
\sncustomdata{\faGithub}{https://github.com/Opvolger}{Github (Privé projecten)}
...
\cvsubsection{Topicus}
	\begin{cvtable}[0.5]
		\cvitem{2022 -- 2025}{(Azure) Cloud Engineer}{}
			...
			\cvitemlist{Key Results:}{Realiseren CICD Pipeline in Azure, Containerization van 20+ applicaties, Kubernetes deployments met behulp van Helm Charts, Onboarden 20+ Teams door middel van workshops}
